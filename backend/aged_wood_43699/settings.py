"""
Django settings for aged_wood_43699 project.
...
ROOT_URLCONF = 'aged_wood_43699.urls'
...
WSGI_APPLICATION = 'aged_wood_43699.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_wood_43699 API",
    "DESCRIPTION": "API documentation for aged_wood_43699 App",
    "VERSION": "v1",
}
